...
INIT_QUERY_SIZE = 2903     # Number of samples in the initial labeled training set
N_QUERIES = 21            # Total number of active learning iterations/cycles
QUERY_BATCH_SIZE = 250     # Number of samples to select for labeling in each iteration
INPUT_FEATURES = 8       # Dimension of the input feature vector
